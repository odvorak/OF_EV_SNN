...
class NeuronPool_Separable_Pool3d_200(nn.Module):
    ...
    def __init__(self, multiply_factor: float = 10.):
        ...
        self.deconv4 = separable_decoder_block(in_channels = 512, out_channels = 256, up_size = (25, 25),  kernel_size = 7, multiply_factor = multiply_factor)
        self.deconv3 = separable_decoder_block(in_channels = 256 * 2, out_channels = 128, up_size = (50, 50),  kernel_size = 7, multiply_factor = multiply_factor)
        self.deconv2 = separable_decoder_block(in_channels = 128 * 2, out_channels = 64, up_size = (100, 100),  kernel_size = 7, multiply_factor = multiply_factor)
        self.deconv1 = separable_decoder_block(in_channels = 64 * 2, out_channels = 32, up_size = (200, 200),  kernel_size = 7, multiply_factor = multiply_factor)

        # Predictor Block


        self.pred4 = separable_predictor_block(in_channels = 256 * 2, out_channels = 2, up_size = (200, 200), kernel_size = 7)
        self.pred3 = separable_predictor_block(in_channels = 128 * 2, out_channels = 2, up_size = (200, 200), kernel_size = 7)
        self.pred2 = separable_predictor_block(in_channels = 64 * 2, out_channels = 2, up_size = (200, 200), kernel_size = 7)
        self.pred1 = separable_predictor_block(in_channels = 32 * 2, out_channels = 2, up_size = (200, 200), kernel_size = 7)
