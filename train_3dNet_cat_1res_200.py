...
train_dataset = DSECDatasetLite(root = '/root/saved_flow_data_train/', file_list = 'train_split_landing.csv', num_frames_per_ts = 11, stereo = False, transform = None)
...
valid_dataset = DSECDatasetLite(root = '/root/saved_flow_data_train/', file_list = 'valid_split_landing.csv', num_frames_per_ts = 11, stereo = False, transform = None)
...
for epoch in range(n_epochs):
    ...
    if save_net & (epoch_loss_valid < test_acc):       
        ...
        torch.save(net.state_dict(), '/root/results/checkpoints_and_logs/checkpoint_l1_epoch{}.pth'.format(epoch))
